...
const Registration = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (agentName == "") {
      toast.error("Sorry! Agency Name (as per MoCAT License) is empty");
      return;
    }
    if (userFullName == "") {
  ...
  return (
    <div>
      <VStack bg={'white'} position={'relative'}>
        <div className="hold-transition py-5 w-100 mb-5">
          <div
            className="login-box"
            style={{ minWidth: "70%", marginLeft: "15%" }}
          >
                          ...
                          <div className="row">
                            <div className="col-lg-6">
                              <p className="text-start">
                                {/* Name of the company  */}
                                Agency Name (as per MoCAT License)
                                <span className="text-danger">*</span>
                              </p>
                              <input
                                type="text"
                                className="form-control border-radius"
                                placeholder="Agency Name (as per MoCAT License)"
                      ...
                      <div className="card">
                        ...
                        <div className="card-body pb-3">
                          <div className="row">
                            ...
                            <div className="col-lg-6 mb-3">
                              <p className="text-start">
                                Ministry of Civil Aviation & Tourism License{" "}
                                <span className="text-danger">*</span>
                              </p>
                              <input
                                id=""
