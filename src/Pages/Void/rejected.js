...
import { getAllQuotationForVoid } from "../../common/allApi";
            ...
            <div className="container-fluid bg-white">
              <div className="row p-2 py-3 ">
                ...
                <div className="col-lg-2 mb-3 mb-lg-0">
                  ...
                  >
                    <option value="Admin_Rejected"> Rejected By Admin</option>
                      ...
                      quotationList?.map((item, index) => {
                        return (
                          ...
                          >
                            ...
                            <td>
                              {" "}
                              {item?.adminRemarks ? item?.adminRemarks : "N/A"}
                            </td>
                            <td>
