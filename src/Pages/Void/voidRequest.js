...
import VoidableFlightInfo from "./components/voidableFlightInfo";
...
const VoidRequest = () => {
  ...
  const handelVoidRequestAccept = async () => {
    setIsdesabled(true);
    try {
      const response = await getVoidRequestAccept(
        summary?.groupId,
        "true",
        summary?.editCount
      );
  ...
  const handelVoidRequestReject = async () => {
    setIsReject(true);
    try {
      const response = await getVoidRequestAccept(
        summary?.groupId,
    ...
    <div>
      ...
      <div className="content-wrapper search-panel-bg">
              ...
              <div className="col-lg-8 box-shadow bg-white rounded">
                <div className="row bg-light rounded">
                  <div className="d-flex justify-content-start align-items-center py-2 gap-3">
                    <div className="fw-bold">Void For {basicInfo?.route}</div>
                    <button
                      type="button"
                ...
                <div className="pb-5">
                  ...
                  <div className="row m-2">
                    <div className="table-responsive px-0">
                      <table
                        className="table table-bordered my-2 mb-3 table-lg"
                        style={{ fontSize: "14px" }}
                      >
                        <tbody>
                          <tr>
                      ...
                      <>
                        ...
                        <div className="row" style={{ fontSize: "14px" }}>
                          <Flex
                            ...
                            lineHeight="1.8"
                          >
                            <Text fontWeight={600}>Total Void Charge</Text>

                            {summary?.hasQuotation ? (
                              <Text>{summary?.totalVoidCharge}AED</Text>
                            ) : (
                              <Text color={"red"}>Waiting for Quotation</Text>
                            )}
                          </Flex>
                        ...
                        <div className="row" style={{ fontSize: "14px" }}>
                          <Flex
                            ...
                            lineHeight="1.8"
                          >
                            <Text fontWeight={600}>Refundable Amount</Text>

                            {summary?.hasQuotation ? (
                              <Text>{summary?.totalVoidable}AED</Text>
                            ) : (
                              <Text color={"red"}>Waiting for Quotation</Text>
                            )}
                          </Flex>
        ...
        >
          ...
          <AlertDialogContent>
            <AlertDialogHeader> Confirm Void Action?</AlertDialogHeader>
            <AlertDialogCloseButton />
            <AlertDialogBody>
              Do you want to Accept or Reject the void request?
            </AlertDialogBody>
            <AlertDialogFooter>
              <Button
                isDisabled={desabled}
                onClick={handelVoidRequestAccept}
              ...
              <Button
                ...
                colorScheme="orange"
                ml={3}
                onClick={handelVoidRequestReject}
              >
                Reject
              </Button>
            </AlertDialogFooter>
          ...
          <AlertDialogContent>
            ...
            <AlertDialogBody padding={5}>
              ...
              <Text className="text-justify">
                ...
                Supplier API, the automated void process is currently
                unavailable. However, we are proceeding with your request
                through our Manual Void process.
              </Text>
