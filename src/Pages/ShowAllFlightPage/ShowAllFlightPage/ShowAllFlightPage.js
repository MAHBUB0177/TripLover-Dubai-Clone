...
import { searchFlights } from "../../../common/allApi";
...
const ShowAllFlightPage = () => {
  ...
  const handleSwap = (index) => {
    // alert(index)
    if (index === 0) {
      if (originRef.current.value !== undefined && destinationRef.current.value !== undefined) {
    ...
    if (index === 1) {
      if (originRef1.current.value !== undefined && destinationRef1.current.value !== undefined) {
    ...
    if (index === 2) {
      if (originRef2.current.value !== undefined && destinationRef2.current.value !== undefined) {
    ...
    if (index === 3) {
      if (originRef3.current.value !== undefined && destinationRef3.current.value !== undefined) {
    ...
    if (index === 4) {
      if (originRef4.current.value !== undefined && destinationRef4.current.value !== undefined) {
    ...
    if (index === 5) {
      if (originRef5.current.value !== undefined && destinationRef5.current.value !== undefined) {
  ...
  useEffect(() => {
    ...
    if (String(tripType) === "One Way" && apiCall) {
      ...
      const getData = async () => {
        ...
        //   setLoading(false);
        //   toast.error("Please check your internat connection!")
        //   return
        // }
        const response = await searchFlights(searchParamOnedWay);
        setFetchFlighData(await response.data.item1);
      ...
      setRange({ ...range, startDate: currentDateDepart, endDate: currentDateReturn })
      const searchData = {
        origin: origin,
        destination: destination,
        journeyDate: currentDateDepart,
                      ...
                      >
                        <div className="row">
                          <div className="d-flex justify-content-between flex-wrap">
                            <div>
                              <div className={`${tripType === "One Way" ? "button-color" : "tripType_bg_color "} form-check form-check-inline p-2 me-1 border-radius`}>
                                <input className="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="One Way" onClick={() => handleTripType("One Way")} checked={tripType === "One Way" && true} />
                                <label className="form-check-label text-white" for="inlineRadio1">One Way</label>
                              </div>
                              <div className={`${tripType === "Round Trip" ? "button-color" : "tripType_bg_color "} form-check form-check-inline p-2 me-1 border-radius`}>
                                <input className="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="Round Trip" onClick={() => handleTripType("Round Trip")} checked={tripType === "Round Trip" && true} />
                                <label className="form-check-label text-white" for="inlineRadio2">Round Trip</label>
                              </div>
                              <div className={`${tripType === "Multi City" ? "button-color" : "tripType_bg_color "} form-check form-check-inline p-2 border-radius`}>
                                <input className="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio3" value="Multi City" onClick={() => handleTripType("Multi City")} checked={tripType === "Multi City" && true} />
                                <label className="form-check-label text-white" for="inlineRadio3">Multi City</label>
                              </div>
                            </div>
                            <div>
                              <div className="d-flex gap-2">
                                <div className="d-flex align-self-center passenger">
                                  <div className="d-flex ageselectpadnotx align-items-center inputgroup">
                                    <div style={{ position: "relative" }}>
                                      ...
                                      >
                                        <Text className="d-flex align-items-center" fontSize={{ base: '12px', sm: '12px', md: '15px', lg: '15px' }}>
                                          <Text className="px-1" id="valPerson">
                                            {adultCount +
                                              childCount +
                                              infantCount} Traveller <i className="fa fa-angle-down ps-1" aria-hidden="true"></i>
                                          </Text>
                                        </Text>
                                      </button>
                                      <div
                                ...
                                <div>
                                  <button
                                    ...
                                    aria-expanded="false"
                                  >
                                    <Text id="valClass" fontSize={{ base: '12px', sm: '12px', md: '15px', lg: '15px' }}>{travelClassType} <i className="fa fa-angle-down ps-1" aria-hidden="true"></i></Text>
                                  </button>
                                  <ul
                                    id="classList"
                                  ...
                                  >
                                    ...
                                    <li
                                      className="dropdown-item dropdown-item-selected"
                                      onClick={() => setTravelClassType("Premium Economy")}
                                      style={{ cursor: "pointer" }}
                                    >
                                      Premium Economy
                                    </li>
                        ...
                        <div className="row pt-1 position-relative">
                          <div className="col-lg-4 forms">
                            ...
                            <span className="address">
                              <input
                                ...
                                ref={originRef}
                                onClick={() => {
                                  setDepartValue({ ...departValue, one: originRef.current.value ? originRef.current.value : departValue.one });
                                  (originRef.current.value = "");
                                }}
                                onBlur={() => {
                                  if (departValue.one && originRef.current.value === "") {
                          ...
                          <div className="swap d-none d-lg-block">
                            <label className="swap">
                              <span className="text-danger fw-bold icon" onClick={() => handleSwap(0)}>
                          ...
                          <div className="col-lg-4 forms">
                            ...
                            <span className="address">
                              <input
                                ...
                                ref={destinationRef}
                                onClick={() => {
                                  setReturnValue({ ...returnValue, one: destinationRef.current.value ? destinationRef.current.value : returnValue.one });
                                  (destinationRef.current.value = "")
                                }
                                }
                                onBlur={() => {
                                  if (returnValue.one && destinationRef.current.value === "") {
                          ...
                          <div className="col-lg-4">
                            <div className="row">
                              <div className={tripType === "Round Trip" ? "col-lg-6 pe-0" : "col-lg-12"}>
                                <label
                                  htmlFor="formGroupExampleInput"
                                  className="form-label"
                                >
                        ...
                        {tripType === "Multi City" ? (
                          <>
                            ...
                            >
                              <div className="col-lg-4 forms">
                                ...
                                <span className="address">
                                  <input
                                    ...
                                    ref={originRef1}
                                    onClick={() => {
                                      setDepartValue({ ...departValue, two: originRef1.current.value ? originRef1.current.value : departValue.two });
                                      (originRef1.current.value = "");
                                    }}
                                    onBlur={() => {
                                      if (departValue.two && originRef1.current.value === "") {
                              ...
                              <div className="swap d-none d-lg-block">
                                <label className="swap">
                                  <span className="text-danger fw-bold icon" onClick={() => handleSwap(1)}>
                                    <i className="fas fa-exchange-alt fa-1x"></i>
                                  </span>
                                </label>
                              </div>
                              <div className="col-lg-4 forms">
                                ...
                                <span className="address">
                                  <input
                                    ...
                                    ref={destinationRef1}
                                    onClick={() => {
                                      setReturnValue({ ...returnValue, two: destinationRef1.current.value ? destinationRef1.current.value : returnValue.two });
                                      (destinationRef1.current.value = "")
                                    }
                                    }
                                    onBlur={() => {
                                      if (returnValue.two && destinationRef1.current.value === "") {
                            ...
                            >
                              <div className="col-lg-4">
                                ...
                                <span className="address">
                                  <input
                                    ...
                                    ref={originRef2}
                                    onClick={() => {
                                      setDepartValue({ ...departValue, three: originRef2.current.value ? originRef2.current.value : departValue.three });
                                      (originRef2.current.value = "");
                                    }}
                                    onBlur={() => {
                                      if (departValue.three && originRef2.current.value === "") {
                              ...
                              <div className="swap d-none d-lg-block">
                                <label className="swap">
                                  <span className="text-danger fw-bold icon" onClick={() => handleSwap(2)}>
                                    <i className="fas fa-exchange-alt fa-1x"></i>
                                  </span>
                                </label>
                              </div>
                              <div className="col-lg-4 forms">
                                ...
                                <span className="address">
                                  <input
                                    ...
                                    ref={destinationRef2}
                                    onClick={() => {
                                      setReturnValue({ ...returnValue, three: destinationRef2.current.value ? destinationRef2.current.value : returnValue.three });
                                      (destinationRef2.current.value = "")
                                    }
                                    }
                                    onBlur={() => {
                                      if (returnValue.three && destinationRef2.current.value === "") {
                                        destinationRef2.current.value = returnValue.three
                                      }
                                    }}
                                    placeholder="To"
                                    id="txtTo2"
                            ...
                            >
                              <div className="col-lg-4 forms">
                                ...
                                <span className="address">
                                  <input
                                    ...
                                    ref={originRef3}
                                    onClick={() => {
                                      setDepartValue({ ...departValue, four: originRef3.current.value ? originRef3.current.value : departValue.four });
                                      (originRef3.current.value = "");
                                    }}
                                    onBlur={() => {
                                      if (departValue.four && originRef3.current.value === "") {
                              ...
                              <div className="swap d-none d-lg-block">
                                <label className="swap">
                                  <span className="text-danger fw-bold icon" onClick={() => handleSwap(3)}>
                                    <i className="fas fa-exchange-alt fa-1x"></i>
                                  </span>
                                </label>
                              </div>
                              <div className="col-lg-4 forms">
                                ...
                                <span className="address">
                                  <input
                                    ...
                                    ref={destinationRef3}
                                    onClick={() => {
                                      setReturnValue({ ...returnValue, four: destinationRef3.current.value ? destinationRef3.current.value : returnValue.four });
                                      (destinationRef3.current.value = "")
                                    }
                                    }
                                    onBlur={() => {
                                      if (returnValue.four && destinationRef3.current.value === "") {
                                        destinationRef3.current.value = returnValue.four
                                      }
                                    }}
                                    placeholder="To"
                                    id="txtTo3"
                            ...
                            >
                              <div className="col-lg-4">
                                ...
                                <span className="address">
                                  <input
                                    ...
                                    ref={originRef4}
                                    onClick={() => {
                                      setDepartValue({ ...departValue, five: originRef4.current.value ? originRef4.current.value : departValue.five });
                                      (originRef4.current.value = "");
                                    }}
                                    onBlur={() => {
                                      if (departValue.five && originRef4.current.value === "") {
                              ...
                              <div className="swap d-none d-lg-block">
                                <label className="swap">
                                  <span className="text-danger fw-bold icon" onClick={() => handleSwap(4)}>
                                    <i className="fas fa-exchange-alt fa-1x"></i>
                                  </span>
                                </label>
                              </div>
                              <div className="col-lg-4 forms">
                                ...
                                <span className="address">
                                  <input
                                    ...
                                    ref={destinationRef4}
                                    onClick={() => {
                                      setReturnValue({ ...returnValue, five: destinationRef4.current.value ? destinationRef4.current.value : returnValue.five });
                                      (destinationRef4.current.value = "")
                                    }
                                    }
                                    onBlur={() => {
                                      if (returnValue.five && destinationRef4.current.value === "") {
                                        destinationRef4.current.value = returnValue.five
                                      }
                                    }}
                                    placeholder="To"
                                    id="txtTo4"
                            ...
                            >
                              <div className="col-lg-4 forms">
                                ...
                                <span className="address">
                                  <input
                                    ...
                                    ref={originRef5}
                                    onClick={() => {
                                      setDepartValue({ ...departValue, six: originRef5.current.value ? originRef5.current.value : departValue.six });
                                      (originRef5.current.value = "");
                                    }}
                                    onBlur={() => {
                                      if (departValue.six && originRef5.current.value === "") {
                              ...
                              <div className="swap d-none d-lg-block">
                                <label className="swap">
                                  <span className="text-danger fw-bold icon" onClick={() => handleSwap(5)}>
                                    <i className="fas fa-exchange-alt fa-1x"></i>
                                  </span>
                                </label>
                              </div>
                              <div className="col-lg-4 forms">
                                ...
                                <span className="address">
                                  <input
                                    ...
                                    ref={destinationRef5}
                                    onClick={() => {
                                      setReturnValue({ ...returnValue, six: destinationRef5.current.value ? destinationRef5.current.value : returnValue.six });
                                      (destinationRef5.current.value = "")
                                    }
                                    }
                                    onBlur={() => {
                                      if (returnValue.six && destinationRef5.current.value === "") {
                        ...
                        <div className="row">
                          <div className="col-lg-12">
                            <div className="d-flex justify-content-center">
                              <button
                                className="btn text-white mt-3 text-center fw-bold"
                                style={{ backgroundColor: "#7c04c0", borderRadius: "25px" }}
                              >
                                Search Flight
                              </button>
                            </div>
          ...
          <div style={{ minHeight: "600px" }}>
            {fetchFlighData !== null && fetchFlighData !== undefined ? (
              loading ? (
                ...
                <>
                  {
                    tripType !== "Multi City" && <div className="container box-shadow content-width">
                      <div className="row py-3">
                        {
                          tripType === "One Way" && <div className="col-lg-6"></div>
                        }
                        {
                          tripType !== "Multi City" && <div className="col-lg-6 d-flex flex-wrap gap-2 justify-content-end align-items-center">
                            <p className="fw-bold button-color p-2 text-white border-radius">Departure : </p>
                            <button className="btn button-color text-white d-flex gap-2 align-items-center border-radius" disabled={moment(currentDateDepart).format("DD-MMMM-YYYY") === moment().format("DD-MMMM-YYYY") ? true : false} onClick={() => handleDepartPreviousDay()}> <FaRegArrowAltCircleLeft /> Previous</button>
                            <p className="border px-2 py-1 border-radius">{moment(currentDateDepart).format("DD-MMMM-YYYY")}</p>
                            <button className="btn button-color text-white d-flex gap-2 align-items-center border-radius" disabled={tripType === "One Way" ? false : moment(currentDateDepart).format("DD-MMMM-YYYY") === moment(currentDateReturn).format("DD-MMMM-YYYY") ? true : false} onClick={() => handleDepartNextDay()}>Next <FaRegArrowAltCircleRight /></button>
                          </div>
                        }

                        {
                          tripType === "Round Trip" && <div className="col-lg-6 d-flex flex-wrap gap-2 justify-content-end align-items-center">
                            <p className="fw-bold button-color p-2 text-white border-radius">Return : </p>
                            <button className="btn button-color text-white d-flex gap-2 align-items-center border-radius" disabled={moment(currentDateDepart).format("DD-MMMM-YYYY") === moment(currentDateReturn).format("DD-MMMM-YYYY") ? true : false} onClick={() => handleReturnPreviousDay()}> <FaRegArrowAltCircleLeft /> Previous</button>
                            <p className="border px-2 py-1 border-radius">{moment(currentDateReturn).format("DD-MMMM-YYYY")}</p>
                            <button className="btn button-color text-white d-flex gap-2 align-items-center border-radius" onClick={() => handleReturnNextDay()}>Next <FaRegArrowAltCircleRight /></button>
                          </div>
                        }
                      </div>
                    </div>
