                ...
                <div className="card card-primary ">
                  <div className="card-body ">
                    <button
                      disabled={!currentUser?.isAgent}
                      type="button"
                      className="btn button-color text-white fw-bold btn-block border-radius w-100"
                    ...
                    <button
                      type="button"
                      className="btn button-color text-white fw-bold btn-block w-100 border-radius"
                      id="changePassword"
                      data-bs-toggle="modal"
                            ...
                            <div className="table-responsive">
                              <table className="table table-borderless align-middle table-striped text-start fw-bold ">
                                <tbody>
                                  ...
                                  <tr>
                                    <td>Account Manager Mobile</td>
                                    <td>:</td>
                                    <td>{accountManager?.mobileNo}</td>
                                  </tr>
                                </tbody>
                              </table>
                            </div>
