...
import {
  getAllQuotation,
  getAllQuotationForReissue,
  getAllQuotationForVoid,
} from "../../common/allApi";
...
const ReissueQuotationHistory = () => {
  ...
  useEffect(() => {
    const filteredData = quotationList?.filter(
      (item) => item.reissueStatus === "Reissued" || item.status === "Adjusted"
    );
      ...
      <section className="content pb-5">
        ...
        <form encType="multipart/form-data" style={{ minHeight: "500px" }}>
          ...
          {/* <div className="table-responsive">
                        ...
                        <tr key={index}>
                          ...
                          <td>
                            <div className="mb-2">
                              ...
                              >
                                {handleViewStatus(item?.reissueStatus)}
                              </span>
                            </div>
                          </td>
            ...
            {filterQuotationData?.length === 0 && !isLoading && <NoDataFound />}
          </div> */}
...
export default ReissueQuotationHistory;
