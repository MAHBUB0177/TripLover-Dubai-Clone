          ...
          {!isChecked ? (
            <>
              ...
              <Text>
                ...
                that agents report for the tickets they sell or request. ADMs
                are a common accounting tool for airlines and agents to settle
                their transactions. To reduce the amount of ADM, it is
                recommended that agencies go through the booking policies and
                the ADM policies of the airlines they are ticketing from.
              </Text>
              ...
              <Text>
                ...
                <span>
                  ...
                  circumvent ticketing time limits or to meet GDS productivity
                  are considered churning bookings. The threshold for churning
              ...
              <Text>
                ...
                <span>
                  ...
                  agent should either issue a ticket or cancel the booking
                  before the TTL. Un-ticketed bookings at the time limit will be
              ...
              <Text>
                ...
                <span>
                  ...
                  and 50% for domestic route of the bookings for flights
                  departing within the month will be considered as high
                  cancellation.{" "}
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  ...
                  passenger and/orsame route and same date. Duplicate
                  un-ticketed bookings will be cancelled by the airlines.{" "}
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  ...
                  with the passenger due to inadequacy of contact information,
                  the concerned agencies will be held responsible for that.
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  {" "}
                  Bookings will be checked for segments where the passenger is
                  due for departure on the same date but on a different
                  route/destination. Airlines will cancel un-ticketed bookings
                  and send a warning for ticketed bookings.
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  {" "}
                  Booking will be checked to determine if it is a booking
                  created by a travel agent purely for test/training purposes.
                  airlines will cancel all test/training bookings.
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  ...
                  subsequent segments followed by the NoShow segment.
                  Requirement of cancelling the No-show passenger may vary from
                  24 to 72 hours prior to flight, check with the specific
                  airlines for specifications.
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  Travel agents must cancel and remove all WL/HL segments at
                  least 72 hours before flight departure, airlines will cancel
                  all un-ticketed waitlisted booking 72 hours prior to departure
              ...
              <Text>
                ...
                <span>
                  ...
                  ticket numbers. If tickets have not been issued for all names,
                  a warning will be sent to the agent and if no action is
                  observed, then airlines will split the PNR and cancel all
                  unticked passengers.
                </span>
              </Text>
              ...
              <Text>
                <span style={{ fontWeight: "bold" }}>
                  14. Inactive Segments:
                </span>{" "}
                <span>
                  Travel Agents must promptly remove all unwanted segments with
                  status codes HX, UN. All inactive segments with the above
                  status codes that are not removed 72 hours prior to departure
              ...
              <Text>
                ...
                <span>
                  ...
                  <div style={{ paddingLeft: "30px" }}>
                    ...
                    <p>iv. Others </p>
                    <p>
                      v. airlines will inspect and send a warning for booking
                      with incomplete information and finally missing APIS PNR
              ...
              <Text>
                ...
                <span>
                  Conditions specified in the airline's group contract/policy
                  will be audited, if any violation is detected action will be
                  taken accordingly.
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  airlines will also check across multiple individual bookings
                  for a large group from the same agent and a warning will be
                  sent to the concerned agencies.
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  ...
                  after a booking has been made in an airline's inventory
                  system. Airlines do not allow passive segments to be used for
                  other reasons, including the following –<br />
                  <div style={{ paddingLeft: "30px" }}>
              ...
              <Text>
                ...
                <span>
                  Booking and ticketing will be as per the available dedicated
                  RBD that has been assigned by the airline for a selected OD
                  ...
                  Airlines. A flight from Dhaka (DAC) to Singapore (SIN) via
                  Dubai (DXB) is booked and the DXB-SIN segment is cancelled
                  will be treated as OD or POC violation and the agency will be
                  sent an ADM by the airlines.
                </span>
              </Text>
            ...
            <>
              ...
              <Text pt={"3"}>
                ...
                Manual) অনুযায়ী, নীচে প্রদত্ত এডিএম পলিসি ট্রাভেল চ্যাম্প এর
                সাথে চুক্তিবদ্ধ এয়ারলাইন্সগুলো প্রয়োগ করার অধিকার রাখে।
              </Text>
              ...
              <Text>
                ...
                দালিলিক উপায়কে এজেন্সি ডেবিট মেমো বা এডিএম (ADM) বলে। এজেন্টরা
                যে টিকিট বিক্রি করে বা বুক করে এর বিপরীতে রিপোর্ট করা অর্থের
                পরিমাণে কোনো অসামঞ্জস্য থাকলে তা সংশোধন করতেও এডিএম ব্যবহৃত হয়।
                এই অ্যাকাউন্টিং টুলটি এয়ারলাইন এবং এজেন্টদের লেনদেন নিষ্পত্তি
                করার একটি মাধ্যম। এডিএম-এর মাধ্যমে জরিমানার পরিমাণ কমাতে, একটি
              ...
              <Text>
                ...
                <span>
                  ...
                  পূরণের জন্য অথবা অন্য কোনো কারণে বারবার বুকিং এবং ক্যান্সেল
                  করলে তাকে চার্নিং বুকিং হিসেবে বিবেচনা করা হয়। ৩ বারের বেশি
                  চার্নিং (বুকিং ক্যান্সেল করে পুনরায় ধরা) করলে চতুর্থ বা তার
                  বেশি বারের ক্ষেত্রে এয়ারলাইন এডিএম চার্জ করতে পারে।
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  ...
                  টিকিট ইস্যু করতে হবে অথবা টাইম লিমিট শেষ হবার আগে টিকেটের
                  বুকিং বাতিল করতে হবে। সময় সীমা অতিক্রম হয়ে গেলে এয়ারলাইন
                  বুকিং বাতিল করে দেবে।
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  বুকিংটি আসল নাম নাকি জাল/কাল্পনিক নাম দিয়ে করা তা নির্ধারণ
                  করতে এয়ারলাইন্ চেক করে থাকে। এয়ারলাইনগুলি নির্দিষ্ট
                  জাল/কাল্পনিক নাম ধারণকারী সমস্ত বুকিং বাতিল করবে।
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  আন্তর্জাতিক রুটের জন্য 60% এর বেশি এবং অভ্যন্তরীণ রুটের
                  ফ্লাইটের 50% এর বেশি বুকিং ক্যান্সেলেশনকে “মাত্রাতিরিক্ত
                  ক্যান্সেলেশন” বিবেচনা করা হবে এবং সেক্ষেত্রে এয়ারলাইন এডিএম
                  পাঠাতে পারে।
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  ...
                  ই-মেইল ঠিকানা ইত্যাদি তথ্য বুকিং এর সাথে থাকা আবশ্যক।
                  যোগাযোগের তথ্যের অপর্যাপ্ততার কারণে যাত্রা সংক্রান্ত কোনো
                  গুরুত্বপূর্ণ প্রয়োজনে যাত্রীর সাথে যোগাযোগ করা সম্ভব না হলে
                  তার জন্য সংশ্লিষ্ট এজেন্সি দায়ী থাকবে।
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  ...
                  টিকিট কাটার পর যাত্রীর অপ্রয়োজনীয় টিকিট ক্যান্সেল করতে ব্যর্থ
                  হন এবং ফ্লাইট ছেড়ে যায় সে ক্ষেত্রে এটি নো-শো হিসেবে বিবেচিত
                  হবে। নো-শো বিমানের সিট ইনভেন্টরি নষ্ট করে। এয়ারলাইন্স
                  এক্ষেত্রে নো-শো সেগমেন্ট এর পরের সমস্ত সেগমেন্ট বাতিল করবে। যে
                  যাত্রী যাবে না তার টিকেট এয়ারলাইন ভেদে ২৪ বা ৭২ ঘণ্টা আগে
                  বাতিল করার প্রয়োজন হতে পারে। নির্দিষ্ট এয়ারলাইনের পলিসি
                  অনুসরণ করে পদক্ষেপ নিতে হবে।
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  ...
                  সমস্ত WL/HL সেগমেন্ট বাতিল করে সরিয়ে ফেলতে হবে। নতুবা
                  এয়ারলাইন 72 ঘণ্টা আগে সমস্ত টিকিট-বিহীন ওয়েটলিস্টেড বুকিং
                  বাতিল করবে এবং এর পরবর্তী সকল কনফার্মড সেগমেন্টও বাতিল করে
                  দেবে।
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  ...
                  রাখা আবশ্যক) রেখে বুকিং তৈরি করতে হবে। MCT না রেখে করা
                  বুকিংগুলি এয়ারলাইন বাতিল করে দেবে এবং ট্রাভেল এজেন্টকে
                  ওয়ার্নিং পাঠাবে।
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  একাধিক প্যাসেঞ্জারযুক্ত PNR এ যদি সব নামের জন্য টিকিট ইস্যু
                  করা না হয়, তাহলে এজেন্টকে একটি সতর্কবার্তা পাঠানো হবে এবং
                  এরপরও কোনো পদক্ষেপ না নিলে, এয়ারলাইন PNR স্প্লিট করে টিকেট
                  ইস্যু না হওয়া সমস্ত যাত্রীদের বুকিং বাতিল করে দেবে।
                </span>
              </Text>

              <Text>
                <span style={{ fontWeight: "bold" }}>
                  13. ইনএক্টিভ সেগমেন্ট:
                </span>{" "}
                <span>
                  ট্র্যাভেল এজেন্টদের অবশ্যই স্ট্যাটাস কোড HX, UN সহ সমস্ত
                  অবাঞ্ছিত সেগমেন্টগুলো সরিয়ে ফেলতে হবে। উপরোক্ত স্ট্যাটাস কোড
                  সহ সমস্ত ইনএক্টিভ সেগমেন্ট যদি ফ্লাইট ছাড়ার 72 ঘণ্টার আগে
                  সরানো হয় না হয় তবে তা ভায়োলেশন হিসাবে বিবেচিত হবে।
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  ...
                  System (APIS) সংরক্ষণের জন্য আন্তর্জাতিক যাত্রার ক্ষেত্রে
                  PNR-এ নিম্নলিখিত তথ্যগুলি অবশ্যই অন্তর্ভুক্ত করতে হবে:
                  <br />
                  <div style={{ paddingLeft: "30px" }}>
              ...
              <Text>
                ...
                <span>
                  গ্রুপ বুকিংগুলি এয়ারলাইনের নির্দিষ্ট পলিসি অনুসারে অডিট করা
                  হবে, কোনো লঙ্ঘন ধরা পড়লে সেই অনুযায়ী ব্যবস্থা নেওয়া হবে।
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  শুধুমাত্র টিকেট ইস্যুর সুবিধার্থে যদি প্যাসিভ সেগমেন্ট তৈরি
                  করা হয় এবং টিকেট কাটার সাথে সাথে ক্যান্সেল করে দেয়া হয়, তবেই
                  প্যাসিভ সেগমেন্ট গ্রহণযোগ্য। জিডিএস এর প্রোডাক্টিভিটি কোটা
                  পূরণ বা ফেয়ার রুল এড়িয়ে টিকেট কাটার জন্য প্যাসিভ সেগমেন্ট
                  ব্যবহারের অনুমতি নেই। <br />
                </span>
              </Text>
              <Text>
                ...
                <span>
                  ...
                  ভুল বানান সংশোধনে সহায়তার জন্য এয়ারলাইনের সেন্ট্রাল
                  রিজার্ভেশন কন্ট্রোলের সাথে যোগাযোগ করুন।
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  যাত্রীকে অবশ্যই তার টিকিটে দেখানো যাত্রাপথের ক্রম অনুসারে
                  ভ্রমণ করতে হবে। সিকোয়েন্স ব্রেক যাত্রা এয়ারলাইন্স দ্বারা
                  দৃঢ়ভাবে নিষিদ্ধ।
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  ভিজিট ভিসা-ধারী যাত্রীদের রিটার্ন টিকিট বুকিং করে শুধুমাত্র
                  একটি সেগমেন্টের বিপরীতে টিকেট ইস্যু করা যাবে না।
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  নির্দিষ্ট অরিজিন এবং ডেস্টিনেশনের জন্য যাত্রার সিকোয়েন্স
                  অনুসারে এয়ারলাইন যে আরবিডি নির্ধারণ করে দেবে সেই অনুসারে বুকিং
                  ও টিকেটিং করতে হবে। অরিজিন ডেস্টিনেশন বাইপাস করে নির্ধারিত
                  ফেয়ারের থেকে কম ফেয়ার ক্লাস বুক করার জন্য সেগমেন্ট ম্যানিপুলেট
                  করে বুকিং করলে তা ওডি ও পিওসি ভায়োলেশন বিবেচিত হবে। যেমন, যে
                  Dac-Sin ফ্লাইট DXB ঘুরে যায়, সেটি বুকিং করে DXB-SIN সেগমেন্ট
                  ক্যান্সেল করলে OD এবং POC ভায়োলেশন হবে এবং এয়ারলাইন এজেন্সিকে
                  এডিএম পাঠাবে।
                </span>
              </Text>
              ...
              <Text>
                ...
                <span>
                  ...
                  কারনে দেশের বাইরের ট্রাভেল এজেন্সির পিসিসি থেকে পিএনআর শেয়ার
                  করা দৃঢ়ভাবে নিষিদ্ধ। এ ধরনের বুকিং এর কারনে আসা সকল এডিএম এর
                  জন্য এজেন্সি দায়বদ্ধ থাকবে।
                </span>
              </Text>
